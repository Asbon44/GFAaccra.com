...
const firebaseConfig = {
    databaseURL: "https://gfa-accra-student-portal-default-rtdb.firebaseio.com/",
};
...
function loadStudentData() {
    ...
    const attendanceEl = document.getElementById('st-profile-attendance');
    if (attendanceEl) attendanceEl.textContent = `${currentUser.attendance || 0} times`;
...
window.logout = () => { currentUser = null; window.location.href = 'index.html'; };
